...
import os
import numpy as np
from .augmentations import DataTransform, encoding_image, rgb_image, encoding_image1
...
class Load_Dataset(Dataset):
    ...
    def __init__(self, dataset, random_int, config, training_mode, dataset_type):
        ...
        if training_mode == "self_supervised":  # no need to apply Augmentations in other modes
            ...
            encoding_image1(self.x_data, self.y_data, random_int, self.datafolder_name, config, dataset_type)
