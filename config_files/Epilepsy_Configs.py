class Config(object):
    def __init__(self):
        # 데이터셋 정보
        self.dataset = "Epilepsy"
        self.num_classes = 2
        self.img_type = 1  # 0: gaf / 1:mark / 2:replot /3:cwt
        self.datafolder_name = "new_mark_origin_224x224,all_cv2"
        self.datalen = 100  # 0:all
        ...
        self.modelname = 'resnet10t'  # cnn은 'CNN' resnet10t, 18, 50, resnet101
        self.pretrain = True
        self.img_size = 224
        ...
        #self.embed_dim = (self.patch_size ** 2) * self.input_channels  # psize^2*channel
