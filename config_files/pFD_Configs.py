class Config(object):
    def __init__(self):
        ...
        self.datafolder_name = "new_cwt_origin_224x224,all_cv2"
        self.datalen = 20000  # 0:all
        self.train_ratio = 0.60
        self.valid_ratio = 0.2
        self.seed = 0
        self.output_type = 'resnet'
        ...
        self.modelname = 'resnet18'  # cnn은 'CNN' resnet10t, 18, 50, resnet101
        self.pretrain = True
        self.img_size = 224
