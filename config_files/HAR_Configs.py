class Config(object):
    def __init__(self):
        ...
        self.datafolder_name = "new_cwt_origin_224x224,all"
        ...
        self.beta2 = 0.99
        self.lr = 0.0003
        self.weightdecay=0.03

        self.modelname = 'resnet10t'  # cnn은 'CNN' resnet 10t, 18, 50
        self.pretrain = True
        self.img_size = 224
        self.input_channels = 3  # RGB
        self.kernel_size = 3
        self.div = 2 ** 3  # ** pooling
