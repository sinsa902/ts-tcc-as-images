class Config(object):
    def __init__(self):
        ...
        self.datafolder_name = "new_cwt_origin_224x224,cv2,1000HZ"
        ...
        self.modelname = 'resnet18'  # cnn은 'CNN' resnet10t, 18, 50, resnet101 // densenet은 densenet121
        self.pretrain = True
        self.img_size = 224
        ...
        if self.modelname == 'CNN':
            ...
            self.patch_size = 1
        self.embed_dim = 64  # psize^2*channel
